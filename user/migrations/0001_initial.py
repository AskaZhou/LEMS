# Generated by Django 2.0.2 on 2020-05-31 07:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BreakEquipmentNum', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.BreakEquipment', to_field='BreakEquipmentNum', verbose_name='故障序号')),
                ('eNum', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.Equipment', to_field='eNum', verbose_name='设备号')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.AddField(
            ...
            name='eNum',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.Equipment', to_field='eNum', verbose_name='设备号'),
        ),
        migrations.AddField(
